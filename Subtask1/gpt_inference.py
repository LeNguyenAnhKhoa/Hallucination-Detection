...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Inference clean data using GPT.")
    parser.add_argument('--model', type=str, default = 'gpt-4o-mini', help='Model name to use (e.g., "gpt-4o-mini")')
    parser.add_argument('--output', type=str, default = './Result/gpt-4o-mini.csv', help='Path to output CSV file')
    parser.add_argument('--sleep_time', type=float, default=0.3, help='Sleep time (in seconds) between requests')
